...
<div class="container">
		...
		if(!empty($nome) && !empty($email) && !empty($datacadastro) && !empty($senha)) {
			if($u->cadastrar($nome, $email, $datacadastro, $senha )) {
				...
				<div class="alert alert-primary" role="alert">
					<strong>ParabÃ©ns!</strong> Cadastrado com sucesso.<a href="login.php" class="alert-link" >FaÃ§a o login Aqui agora</a>
				</div>
				<?php
			} else {
				?>
				<div class="alert alert-warning">
					Este usuÃ¡rio jÃ¡ existe! <a href="login.php" class="alert-link">FaÃ§a o login agora</a>
				</div>
				<?php
			}
		} else {
	...
	<form method="POST">
		<div class="form-group">
                    <div>FaÃ§a o seu Cadastro, Ã© simples mesmo, apenas nome, e-mail e senha e despois vc so preenche o seu anuncio</div><br/>
